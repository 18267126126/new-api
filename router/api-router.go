...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		dataRoute.GET("/self/tokens", middleware.UserAuth(), controller.GetUserTokenUsageDates)
		dataRoute.GET("/tokens", middleware.AdminAuth(), controller.GetAllTokenUsageDates)
